...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        imageLabel->setGeometry(QRect(48, 240, 211, 271));
        textEdit = new QTextEdit(centralwidget);
        textEdit->setObjectName("textEdit");
        textEdit->setGeometry(QRect(330, 240, 461, 331));
        loadButton = new QPushButton(centralwidget);
        loadButton->setObjectName("loadButton");
        loadButton->setGeometry(QRect(100, 110, 93, 28));
        recognizeButton = new QPushButton(centralwidget);
        recognizeButton->setObjectName("recognizeButton");
        recognizeButton->setGeometry(QRect(380, 120, 93, 28));
